...
```
# Once you are in, it will open a GUI session, gives you the option to shuitdown, reboot and reset it etc. If a person is logged in it will show their display however without knowing the password or fruther exploitation you want be able to gain further access.
